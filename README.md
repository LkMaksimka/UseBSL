...
## Проверка код с помощью PhoenixBSL
 ...
 2. Скачиваем с github [bsl-language-server](https://github.com/1c-syntax/bsl-language-server/releases) архив **[bsl-language-server_win.zip](https://github.com/1c-syntax/bsl-language-server/releases/download/v0.21.0-ra.7/bsl-language-server_win.zip)**
