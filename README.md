...
### Установка
 ...
 2. Скачиваем с [bsl-language-server](https://github.com/1c-syntax/bsl-language-server/releases) архив **[bsl-language-server_win.zip](https://github.com/1c-syntax/bsl-language-server/releases/download/v0.21.0/bsl-language-server_win.zip)** 
